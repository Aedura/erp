...
const AssignmentForm = ({reqType, data}: { reqType: "create" | "update"; data?: any }) => {
  ...
  return <form onSubmit={onSubmit} className='flex flex-col gap-4'>
    <h1 className='text-xl font-semibold'>{reqType === "create" ? "Create a new" : "Update"} assignment</h1>
    <span className='text-xs text-gray-500 font-medium'>Assignment Information</span>
    <div className="flex items-center justify-center gap-6 flex-wrap">
      ...
      <InputField label="Date" name='dueDate' inputType='date' defaultVal={data?.dueDate} register={register} error={errors?.dueDate} />
    </div>
